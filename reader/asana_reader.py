...
class AsanaReader(BaseReader):
    """Asana reader.
    Reads data from an Asana workspace.
    Args:
    ...
    def load_data(self, workspace_id: str) -> List[Document]:
        ...
        for project in projects:
            logging.info("Project: " + project["name"])
...
if __name__ == "__main__":
    ...
    reader = AsanaReader(args.token)

    logging.info(reader.load_data(workspace_id=args.workspace))
